...
public class SaveHandler extends Handler {
    ...
    FontIcon getFontIcon() {
        return new FontIcon(getIconCode("fa-save"));
    }

    @Override
    String getMenuItemText() {
        return Messages.getString("menu.save.label");
    }

    @Override
    String getTooltipText() {
        return Messages.getString("menu.save.tooltip");
    }
    ...
    KeyCodeCombination getKeyCodeCombination() {
        return new KeyCodeCombination(KeyCode.S, KeyCombination.SHORTCUT_DOWN);
    }
